/*
  # Add paid experiences data
  
  1. Changes
    - Insert all paid experiences into experiences table
    - Set visibility and manager assignment
    
  2. Data
    - All paid experiences from the frontend data
    - Preserves pricing and details
*/

-- Insert paid experiences
